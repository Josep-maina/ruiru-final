...
<section class="privacy-hero">
    ...
    <img src="img/about-hero-bg.jpg" class="hero-bg-image" alt="Privacy Policy Background">
    <div class="container">
        <div class="row align-items-center min-vh-50">
            <div class="col-12 text-center hero-content">
                <h1 class="display-4 fw-bold text-white mb-3">Privacy Policy</h1>
                <p class="lead text-white">How we protect and use your information</p>
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <div class="privacy-content">
                    ...
                    <ul>
                        <li>Fill out contact forms or application forms</li>
                    ...
                    <ul>
                        <li>Email: <a href="mailto:ruirutvc@gmail.com">ruirutvc@gmail.com</a></li>
                        <li>Phone: +254 746 319 919</li>
                        <li>Address: P.O. Box 416-00232 Ruiru, Kiambu County, Kenya</li>
                    </ul>
                </div>
            </div>
        </div>
